...
export function getLastCommitInfo(branch) {
    const lastCommit = execSync(`git log ${branch} -1 --format="%H|%s|%an|%ad"`, { encoding: 'utf-8' }).trim();
...
export function getGitInfo() {
    // This function can be removed or kept for non-merge analysis cases
    return null;
} 